...
def WriteLog(Data):
    ...
    fobj = open("DuplicateRemovalTime.log","a")
    fobj.write(Data+"\n")
    fobj.close()
...
def CreateHeader():
    ...
    fobj.write("Script Name : Duplicate Removal With Time\n")
    fobj.write(Border+"\n")
    fobj.close()
...
def DeleteDuplicate(DirectoryName):
    ...
    return FileCount,DeleteCount



def CreateFooter(FileCount,DeleteCount,ExecTime):
    ...
    fobj.write("Execution Time : "+str(ExecTime)+"\n")
...
def main():
    ...
    FileCount,DeleteCount = DeleteDuplicate(DirectoryName)

    EndTime = time.time()

    ExecTime = EndTime - StartTime

    CreateFooter(FileCount,DeleteCount,ExecTime)
